...
UnscentedKalmanFilterX::UnscentedKalmanFilterX(
  const System& system,
  int state_dim,
  int measurement_dim,
 ...
 */
void UnscentedKalmanFilterX::predict() {
 ...
 */
void UnscentedKalmanFilterX::predictImu(const Eigen::Vector3f& imu_acc, const Eigen::Vector3f& imu_gyro) {
  // calculate sigma points
  ensurePositiveFinite(cov_);
  computeSigmaPoints(mean_, cov_, sigma_points_);
 ...
 * @note state = [px, py, pz, vx, vy, vz, qw, qx, qy, qz, 0, 0, 0, 0, 0, 0]
 */
void UnscentedKalmanFilterX::predictOdom(const Eigen::Vector3f& odom_twist_linear, const Eigen::Vector3f& odom_twist_angular) {
  // calculate sigma points
  ensurePositiveFinite(cov_);
  computeSigmaPoints(mean_, cov_, sigma_points_);
 ...
 */
void UnscentedKalmanFilterX::correct(const VectorXt& measurement) {
...
/* getter */
const VectorXt& UnscentedKalmanFilterX::getMean() const {
  return mean_;
}
const MatrixXt& UnscentedKalmanFilterX::getCov() const {
  return cov_;
}
const MatrixXt& UnscentedKalmanFilterX::getSigmaPoints() const {
  return sigma_points_;
}

System& UnscentedKalmanFilterX::getSystem() {
  return system_;
}
const System& UnscentedKalmanFilterX::getSystem() const {
  return system_;
}
const MatrixXt& UnscentedKalmanFilterX::getProcessNoiseCov() const {
  return process_noise_;
}
const MatrixXt& UnscentedKalmanFilterX::getMeasurementNoiseCov() const {
  return measurement_noise_;
}
const MatrixXt& UnscentedKalmanFilterX::getKalmanGain() const {
  return kalman_gain_;
}

/* setter */
UnscentedKalmanFilterX& UnscentedKalmanFilterX::setMean(const VectorXt& m) {
  mean_ = m;
  return *this;
}
UnscentedKalmanFilterX& UnscentedKalmanFilterX::setCov(const MatrixXt& s) {
  cov_ = s;
  return *this;
}

UnscentedKalmanFilterX& UnscentedKalmanFilterX::setProcessNoiseCov(const MatrixXt& p) {
  process_noise_ = p;
  return *this;
}
UnscentedKalmanFilterX& UnscentedKalmanFilterX::setMeasurementNoiseCov(const MatrixXt& m) {
 ...
 */
void UnscentedKalmanFilterX::computeSigmaPoints(const VectorXt& mean, const MatrixXt& cov, MatrixXt& sigma_points_) {
 ...
 */
void UnscentedKalmanFilterX::ensurePositiveFinite(MatrixXt& cov) {
  return;
