...
public:
  ...
  VectorX computeNextStateWithIMU(const VectorX& current_state, const Eigen::Vector3f& imu_acc,
                                  const Eigen::Vector3f& imu_gyro) const;
  VectorX computeNextStateWithOdom(const VectorX& current_state, const Eigen::Vector3f& odom_twist_lin,
