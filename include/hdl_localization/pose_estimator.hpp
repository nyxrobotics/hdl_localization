...
public:
   ...
   */
  PoseEstimator(pcl::NormalDistributionsTransform<PointT, PointT>::Ptr& registration, const Eigen::Vector3f& pos,
...
private:
  ...
  pcl::NormalDistributionsTransform<PointT, PointT>::Ptr registration_;
};
